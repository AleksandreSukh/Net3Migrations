...
namespace System.Collections.Concurrent
{
    ...
    Node[] segmentCache;*/
        ...
        public T InsertOrUpdate(uint key, Trunc<T> addGetter, Trunc<T, T> updateGetter)
        {
            Node current;
        ...
        public T InsertOrGet(uint key, T data, Trunc<T> dataCreator)
        {
            Node current;
        ...
        bool InsertInternal(uint key, T data, Trunc<T> dataCreator, out Node current)
        {
        ...
        public bool CompareExchange(uint key, T data, Trunc<T, bool> check)
        {
            Node node;
            uint b = key % (uint)size;
            Node bucket;
        ...
        bool ListInsert(Node newNode, Node startPoint, out Node current, Trunc<T> dataCreator)
        {
