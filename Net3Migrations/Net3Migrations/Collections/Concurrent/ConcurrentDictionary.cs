...
namespace System.Collections.Concurrent
{
        ...
        IDictionary, ICollection, IEnumerable
    {
        ...
        public TValue AddOrUpdate(TKey key, Trunc<TKey, TValue> addValueFactory, Trunc<TKey, TValue, TValue> updateValueFactory)
        {
        ...
        public TValue AddOrUpdate(TKey key, TValue addValue, Trunc<TKey, TValue, TValue> updateValueFactory)
        {
        ...
        public TValue GetOrAdd(TKey key, Trunc<TKey, TValue> valueFactory)
        {
        ...
        ICollection<T> GetPart<T>(Trunc<KeyValuePair<TKey, TValue>, T> extractor)
        {
